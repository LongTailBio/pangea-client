      ...
      <Row>
        ...
        <Col lg={10} lgOffset={1}>
          ...
          <p>
            ...
            extension modules. These extension modules may be used to support 
            a wide variety of additional use cases. Critically, extension 
            modules can support search and visualization of data. 
          </p>
          ...
          <p>
            ...
            Analysis-Result-Fields, one each for the forward and reverse reads. 
            Each Field could point to a file stored on the cloud or, for results 
            that require less storage, be stored directly in Pangea.
          </p>
          <p>
            Sample-Groups may also contain Analysis-Results. In this case Analysis-Results 
            are used to represent anything that applies to all the samples at once. 
            An example would be a pairwise distance matrix between all samples in a 
            dataset.
          </p>
          <p>
            Analysis-Results may contain multiple replicates of the same type and each 
            Analysis-Result may contain a list of the other Analysis-Results it was  
            derived from. This helps to ensure provenance of each result and reproducible 
            research.
          </p>
