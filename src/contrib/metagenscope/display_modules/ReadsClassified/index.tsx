...
export class ReadsClassifiedModule extends HighchartsDisplayContainer<
  ReadsClassifiedType,
  ReadsClassifiedProps
> {
  constructor(props: ReadsClassifiedProps) {
    ...
    this.description = (
      <p>
        This chart shows the proportion of reads in each sample assigned to
        different groups.
      </p>
    );
  }
